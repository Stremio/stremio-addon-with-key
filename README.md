...
- addon that uses the addon sdk (alternatively, there are also examples using [Node.js and Express](https://github.com/Stremio/stremio-addon-sdk/blob/master/docs/advanced.md#using-user-data-in-addons))
